...
<head>
    ...
    <style>
        ...
        /* Custom rotating animation for the profile circle background */
        ...
        .profile-bg-glow {
            position: absolute;
            inset: -8px;
            background: linear-gradient(135deg, #FDE047, #FACC15, #EAB308, #CA8A04);
            border-radius: 50%;
            z-index: 0;
...
<body class="bg-[var(--color-bg-base)] text-[var(--color-charcoal)] min-h-screen flex flex-col justify-between">
    ...
    <nav class="w-full py-6 sticky top-0 z-50 bg-[var(--color-bg-base)]/80 backdrop-blur-md border-b border-[var(--color-border-soft)]">
        <div class="container-boxed flex items-center justify-between">
            ...
            <!-- Nav Links (NO About text link in header) -->
                ...
                <div class="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    <div class="lg:col-span-7 space-y-8 animate-founder-left">
                        ...
                        <div class="flex gap-4 pt-4">
                            ...
                            <a href="https://www.linkedin.com/in/balaji-sri-ram-parasa" target="_blank" rel="noopener noreferrer" 
                               class="btn-secondary-veltrix flex items-center gap-2 !py-2.5 !px-5 text-xs font-bold uppercase tracking-widest">
                                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
                                LinkedIn
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-5 flex justify-center animate-founder-right">
                        <div class="relative w-full max-w-[340px] aspect-square">
                            ...
                            <div class="profile-bg-glow shadow-xl"></div>
                            
                            <!-- Circular Framed Image -->
                            <div class="absolute inset-1 rounded-full border border-white bg-white overflow-hidden shadow-inner flex items-center justify-center">
                                <img src="/images/my_image.png" 
                                     alt="{{ __('messages.about_team_1_name') }}" 
                                     class="w-full h-full object-cover rounded-full scale-102 hover:scale-108 transition-transform duration-700"
            ...
            <div class="container-boxed">
                <div class="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                    ...
                    <div class="lg:col-span-5 space-y-8 lg:sticky lg:top-28">
                        <div class="space-y-4">
                            <span class="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--color-accent)]">{{ __('messages.about_subtitle') }}</span>
                        ...
                        <div class="space-y-4 pt-4 border-t border-[var(--color-border-soft)]">
                            <div class="flex gap-4">
                                <div class="w-5 h-5 rounded-full bg-[var(--color-primary)]/10 text-[var(--color-primary)] flex items-center justify-center flex-shrink-0 mt-1">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"></path></svg>
                                </div>
                                <div>
                                    <h4 class="font-bold text-xs uppercase tracking-widest text-[var(--color-charcoal)]">{{ __('messages.about_value_1_title') }}</h4>
                                    <p class="text-xs text-muted-veltrix mt-1">{{ __('messages.about_value_1_desc') }}</p>
                                </div>
                            </div>
                            <div class="flex gap-4">
                                <div class="w-5 h-5 rounded-full bg-[var(--color-primary)]/10 text-[var(--color-primary)] flex items-center justify-center flex-shrink-0 mt-1">
                                ...
                                <div>
                                    <h4 class="font-bold text-xs uppercase tracking-widest text-[var(--color-charcoal)]">{{ __('messages.about_value_2_title') }}</h4>
                                    <p class="text-xs text-muted-veltrix mt-1">{{ __('messages.about_value_2_desc') }}</p>
                                </div>
                            </div>
                            <div class="flex gap-4">
                                <div class="w-5 h-5 rounded-full bg-[var(--color-primary)]/10 text-[var(--color-primary)] flex items-center justify-center flex-shrink-0 mt-1">
                                ...
                                <div>
                                    <h4 class="font-bold text-xs uppercase tracking-widest text-[var(--color-charcoal)]">{{ __('messages.about_value_3_title') }}</h4>
                                    <p class="text-xs text-muted-veltrix mt-1">{{ __('messages.about_value_3_desc') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-7 space-y-12 pl-4 lg:pl-12 border-l border-[var(--color-border-soft)]">
                        <div class="space-y-2">
                            <span class="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--color-primary)]">{{ __('messages.about_timeline_title') }}</span>
                            <h2 class="heading-editorial text-3xl lg:text-4xl text-[var(--color-charcoal)]">The Journey Timeline</h2>
                        </div>

                        <div class="space-y-12 relative before:absolute before:left-3 before:top-4 before:bottom-4 before:w-0.5 before:bg-[var(--color-border-soft)]">
                            
                            <!-- Timeline Track 1 -->
                            <div class="timeline-block relative pl-10 group">
                                <div class="absolute left-[7px] top-2.5 w-2.5 h-2.5 rounded-full bg-slate-300 border-2 border-white group-hover:bg-[var(--color-primary)] group-hover:scale-125 transition-all duration-300"></div>
                                <div class="text-xs font-bold text-[var(--color-accent)] uppercase tracking-wider mb-1">
                                    {{ __('messages.about_timeline_1_year') }}
                                </div>
                                <h3 class="heading-editorial text-xl text-[var(--color-charcoal)] mb-2">{{ __('messages.about_timeline_1_title') }}</h3>
                            ...
                            <div class="timeline-block relative pl-10 group">
                                ...
                                <h3 class="heading-editorial text-xl text-[var(--color-charcoal)] mb-2">{{ __('messages.about_timeline_2_title') }}</h3>
                                <p class="text-sm text-muted-veltrix leading-relaxed">
                            ...
                            <div class="timeline-block relative pl-10 group">
                                ...
                                <h3 class="heading-editorial text-xl text-[var(--color-charcoal)] mb-2">{{ __('messages.about_timeline_3_title') }}</h3>
                                <p class="text-sm text-muted-veltrix leading-relaxed">
    ...
    <footer class="py-12 border-t border-[var(--color-border-soft)] bg-[var(--color-bg-base)]">
        <div class="container-boxed flex flex-col md:flex-row justify-between items-center gap-8">
            <div class="flex items-center gap-2">
                <div class="w-8 h-8 bg-[var(--color-primary)] rounded-lg flex items-center justify-center text-white font-bold text-sm">V</div>
